...
namespace EditorAttributes.Editor.Utility
{
    public static class ReflectionUtils
    {
        ...
        public static FieldInfo FindField(string fieldName, SerializedProperty property)
        {
            ...
            {
                FieldInfo nestedFieldInfo = serializedObjectType.GetField(fieldName, BINDING_FLAGS);
                if (nestedFieldInfo != null)
                    return nestedFieldInfo;
            }

            return FindField(fieldName, property.serializedObject.targetObject);
        }
        ...
        public static PropertyInfo FindProperty(string propertyName, SerializedProperty property)
        {
            ...
            if (serializedObjectType != null)
            {
                PropertyInfo nestedPropertyInfo = serializedObjectType.GetProperty(propertyName, BINDING_FLAGS);
                if (nestedPropertyInfo != null)
                    return nestedPropertyInfo;
            }

            return FindProperty(propertyName, property.serializedObject.targetObject);
        }
        ...
        public static MethodInfo FindFunction(string functionName, SerializedProperty property)
        {
            ...
            return FindFunction(functionName, property.serializedObject.targetObject);
        }
