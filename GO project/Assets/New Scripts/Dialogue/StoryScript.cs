...
public static class StoryScript
{
    ...
    public static StoryConversation Intro()
    {
        return new StoryConversation(IntroId, new List<StoryLine>
        {
            ...
            new StoryLine(Goggle, "Yes, and that's why the emperor wants you in his new \"Go army\"! Need warriors who are both intelligent to beat their army at Go and strong to defeat them in battle after."),
    ...
    public static StoryConversation AfterTrainingHub()
    {
        return new StoryConversation(AfterTrainingHubId, new List<StoryLine>
        {
            ...
            new StoryLine(Goggle, "9 Dan is the highest skill a player can achieve. At that level, players can plan forward hundreds of moves, spot the opponent's weakness instantly, and so much more!"),
